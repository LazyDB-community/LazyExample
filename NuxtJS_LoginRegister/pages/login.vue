      ...
      <div class="md:flex w-full">
        ...
        <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
          <div class="text-center mb-10">
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <button @click="login" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">LOGIN NOW</button>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    login() {
      this.db.connect(this.email, this.password).then((data) => {
        Swal.fire(
          "Connection",
